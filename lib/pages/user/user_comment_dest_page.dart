...
class UserCommentDestPage extends StatefulWidget {
  final int shopId;
  final int commentId;

  const UserCommentDestPage(
      {Key? key, required this.shopId, required this.commentId})
      : super(key: key);

  @override
  _UserCommentDestPageState createState() => _UserCommentDestPageState();
}

class _UserCommentDestPageState extends State<UserCommentDestPage>
