...
class ShopChoosePage extends StatefulWidget {
  ...
  const ShopChoosePage({Key? key, required this.index}) : super(key: key);

  @override
  _ShopChoosePageState createState() => _ShopChoosePageState();
}
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                if (widget.index == 0) {
                                  Get.toNamed(RouteHelper.getReleaseComment(
                                      shopListController
                                          .searchShopList[index].id!));
                                } else if (widget.index == 1) {
                                  Get.toNamed(RouteHelper.getGroupCreate(
                                      shopListController
                                          .searchShopList[index].id!));
                                }
                              },
